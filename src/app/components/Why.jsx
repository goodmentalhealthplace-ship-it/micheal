...
const FEATURES = [
  ...
  { 
    ...
    icon: FaRegLightbulb, 
    description: "We use proven therapeutic techniques and current psychiatric research to guide effective care.", 
    color: BRAND_ACCENT
  },
  { 
    id: 3,
    ...
    description: "Access confidential and convenient care from anywhere using our online system.", 
    color: BRAND_PRIMARY
  },
  { 
    id: 4,
    ...
    icon: FaLock, 
    description: "We maintain strong standards of HIPAA compliance to protect your information and sessions.", 
    color: BRAND_SECONDARY
  },
];
...
function FeatureCard({ feature }) {
  ...
  return (
    <div className="p-6 rounded-3xl bg-gray-50 border border-gray-100 shadow-md flex flex-col text-left h-full">
      <div
        className="mb-4 p-4 rounded-xl inline-flex"
        style={{
          color: feature.color,
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            ...
            {/* IMAGE DIRECTLY AFTER HEADING */}
            <div className="relative w-full max-w-md h-[220px] md:h-[260px] mb-8 rounded-3xl overflow-hidden">
              <Image
                src="/why.png"
